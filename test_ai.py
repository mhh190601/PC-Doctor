...
TEST_CASES = [
    ...
    # --- 新增知识覆盖 (v1.7.0 知识库扩充) ---
    ("U盘插上没反应", ["U盘", "USB", "驱动", "磁盘"], "硬件"),
    ("移动硬盘识别不了", ["硬盘", "USB", "驱动", "磁盘管理"], "硬件"),
    ("WiFi老是掉线", ["WiFi", "网络", "驱动", "掉线", "路由"], "网络"),
    ("电脑密码忘了怎么解锁", ["密码", "账户", "安全", "重置"], "账户"),
    ("蓝牙耳机连不上电脑", ["蓝牙", "连接", "设备", "驱动"], "硬件"),
    ("笔记本电池不耐用", ["电池", "电源", "续航", "笔记本"], "硬件"),
    ("文件误删了怎么恢复", ["恢复", "回收站", "文件", "软件"], "数据"),
    ("删掉的文件还能找回来吗", ["恢复", "回收站", "深度", "扫描"], "数据"),
    ("远程桌面连不上", ["远程", "连接", "防火墙", "IP"], "网络"),
    ("显卡驱动掉了怎么恢复", ["显卡", "驱动", "更新", "设备管理器"], "驱动"),
    ("电脑屏幕一直闪", ["屏幕", "闪烁", "显卡", "驱动", "刷新"], "显示"),
    ("Office激活失败", ["Office", "激活", "密钥", "修复"], "软件"),
    ("内存不足提示怎么办", ["内存", "虚拟内存", "任务", "不足"], "系统"),
    ("电脑没声音了", ["声音", "声卡", "驱动", "音频", "设备"], "驱动"),
    ("输入法不见了怎么恢复", ["输入法", "设置", "语言", "显示"], "软件"),
    ("蓝屏之后进不去系统", ["蓝屏", "启动", "修复", "安全模式", "恢复"], "蓝屏"),
    ("电脑发出刺耳噪音", ["风扇", "散热", "噪音", "清灰"], "硬件"),
